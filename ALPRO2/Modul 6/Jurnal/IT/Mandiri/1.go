...
// tipe bentukan struct lingkaran dengan field:
// titik_pusat bertipe titik dan
// radius, luas, keliling bertipe float64
...
func main() {
	// deklarasi variabel c1 dan c2 bertipe lingkaran
	var c1, c2 lingkaran
	// deklarasi variabel x,  y, dan radius bertipe float64
...
func lingkaran_baru(x, y, r float64) lingkaran {
	...
	tp.x = x
	tp.y = y
	l.titik_pusat.x = tp.x
	l.titik_pusat.y = tp.y
	l.radius = r
	return l
}

func hitung_luas(l *lingkaran) {
	/* IS: l.x, l.y. l.r terdefinisi, l.luas terdefinisi sembarang
	   FS: l.luas berisi nilai */
...
func cetak_data(l lingkaran) {
	...
	*/
	fmt.Printf("Lingkaran berpusat di titik (%v, %v) dan berradius %v ", l.titik_pusat.x, l.titik_pusat.y, l.radius)
	fmt.Printf("memiliki luas %1.f dan keliling sebesar %.1f\n", l.luas, l.keliling)
}
